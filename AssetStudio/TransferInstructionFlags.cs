...
{
    /// <summary>
    /// Transfer instruction flags for serialized files.
    /// These flags control how data is serialized and deserialized.
    /// </summary>
    [Flags]
    public enum TransferInstructionFlags : uint
    {
        None = 0x0,
        /// <summary>
        /// Should we convert PPtrs into pathID, fileID using the PersistentManager
        /// or should we just store the memory InstanceID in the fileID?
        /// </summary>
        ...
        /// <summary>
        /// Used for YAML global PPtr references
        /// </summary>
        ...
        /// <summary>
        /// Should we backup mono variables for an assembly reload?
        /// </summary>
        SerializeMonoReload = 0x1000,
        /// <summary>
        /// Can Unity fast path calculating all meta data?
        /// </summary>
    ...
    {
        public static bool IsRelease(this TransferInstructionFlags flags)
        {
            return (flags & TransferInstructionFlags.SerializeGameRelease) != 0;
        }

        public static bool IsForPrefab(this TransferInstructionFlags flags)
        {
            return (flags & TransferInstructionFlags.SerializeForPrefabSystem) != 0;
        }

        public static bool IsEditorScene(this TransferInstructionFlags flags)
        {
            return (flags & TransferInstructionFlags.SerializeEditorMinimalScene) != 0;
        }

        public static bool IsBuiltinResources(this TransferInstructionFlags flags)
        {
            return (flags & TransferInstructionFlags.IsBuiltinResourcesFile) != 0;
        }

        public static bool ShouldSwapEndian(this TransferInstructionFlags flags)
        {
            return (flags & TransferInstructionFlags.SwapEndianess) != 0;
        }
    }
}
